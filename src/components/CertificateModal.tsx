  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative w-full max-w-4xl rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl text-right font-sans overflow-hidden max-h-[92vh] overflow-y-auto"
      >
