...
import { Key, CheckCircle2, AlertCircle, X, Sparkles, Phone, ArrowLeft } from 'lucide-react';
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-slate-800 bg-slate-900 p-6 sm:p-8 shadow-2xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">
            أدخل كود الكورس أو المذكرة الذي حصلت عليه لتفعيله فوراً على حسابك
          </p>
        </div>
        ...
        <form onSubmit={handleRedeem} className="space-y-4">
          ...
          >
            {isLoading ? 'جاري التحقق من الكود...' : 'تفعيل الكود الآن'}
          </button>
        </form>
