// Supabase client and data persistence adapter for WiKi-PHYSICS
// Connects to Supabase REST and internal backend API for persistent cloud data
...
export type Snapshot = { exists: () => boolean; data: () => any; metadata: { hasPendingWrites: boolean } };
...
export const safeFetch = async (url: string, options: RequestInit = {}, timeoutMs = 8000): Promise<Response | null> => {
